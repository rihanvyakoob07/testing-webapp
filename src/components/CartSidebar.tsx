...
const CartSidebar = ({
  ...
  // Filter out invalid items (null or undefined) and calculate total price
  const validCartItems = cartItems.filter((item) => item !== null && item !== undefined);
        ...
        {validCartItems.length > 0 && (
          <div className="space-y-4 border-t border-border pt-4">
            ...
            <Button 
              ...
              size="lg"
              disabled={total <= 0} // Disable checkout button if total is zero or negative
            >
              Checkout
            </Button>
          </div>
